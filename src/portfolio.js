...
const socialMediaLinks = {
  github: "https://github.com/paolomostardi",
  linkedin: "https://www.linkedin.com/in/paolo-mostardi/",
  gmail: "paolomostardi@gmail.com",
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/StarshipLogo.jpg"),
      date: "2019 – 2020",
      desc: "  Supervised a series of autonomous delivery robot with quick decision making ",
      descBullets: [
        "Remotely controlled delivery robots through web interface",
        "Achieved error-free performance and above-average resolution ratio",
        "Utilised Slack for emergency and team communication"
      ]
    },
    {
      role: "System admin assistant",
      company: "Var Group S.p.A.",
      companylogo: require("./assets/images/VarGroup.jpg"),
      date: "2018 – 2019",
      descBullets: [
        "Led domain migration for PCs",
        "Used scripts for setup, managed post-migration tasks",
        "Ensured app functionality, documented procedures",
        "Trained pre-rollout",
        "Collaborated with service desk under supervision"]
        }
  ]
};
